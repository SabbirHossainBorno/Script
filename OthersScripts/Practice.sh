...
case $option in
    ...
    #if find /etc/rc.d/init.d -name "apache" -type f; then
    
    #echo "apache in /etc/rc.d/init.d"
    
    #elif find /etc/rc.d/init.d -name "tomcat" -type f; then
    
    #cat $(find /etc/rc.d/init.d -name "tomcat" -type f)
    
    #elif grep 'apache-tomcat'; then
    
    #echo "apache in tomcat"
    
    #elif grep 'jakarta-tomcat'; then
    
    #echo "Return"
    
    #else 
    
    #echo "Nothing Found Anything To Restart Apache-Tomcat!"
