...
timeout_duration=60  # Timeout in seconds
        ...
        1)
                ...
                #folder_name="${current_month}_${current_year}"
                ...
                # Start the mysqldump in the background
                mysqldump $smsfailed_db_name > $smsfailed_db_name.sql &
                ...
                echo
                echo -e "${BCyan}Moving [${Color_Off} ${BRed}$smsfailed_db_name.sql${Color_Off} & ${BRed}$smsiTel_db_name.sql${Color_Off} ${BCyan}] To ${Color_Off}${BGreen}/usr/local/$folder_name${Color_Off}"
                echo
                ...
                echo
                echo -e "${BCyan}Moving [${Color_Off} ${BRed}WholeSaleSMSServer$smsFolder${Color_Off} & ${BRed}iTelSMSAppServer$smsAppFolder${Color_Off} ${BCyan}] To ${Color_Off}${BGreen}/usr/local/$folder_name${Color_Off}" 
                echo
                ...
                echo
                cd /usr/local/
                echo -e "${BCyan}Moving [${Color_Off} ${BRed}Apache - Tomcat${Color_Off} ${BCyan}] To ${Color_Off}${BGreen}/usr/local/$folder_name${Color_Off}"
                echo
