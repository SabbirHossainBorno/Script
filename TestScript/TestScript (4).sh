...
#if find / -name "$find" | read
#then
#echo Yes We Found $find In Your Server....
...
echo -e "${Green}The ${Red}script ${Yellow}was executed ${URed}successfully!${Color_Off}"
