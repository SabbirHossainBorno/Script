...
function fn_TransferFile_new_server() {
    ...
    echo -e "${BPurple}                      [${Color_Off} ${BCyan}Data Transfer Process${Color_Off} ${BPurple}]                      ${Color_Off}"
    echo
...
function run_source_files() {
    echo -e "${BPurple}                           [${Color_Off} ${BCyan}Source Run${Color_Off} ${BPurple}]                            ${Color_Off}"
    echo
    # Check if MySQL version 8 is installed on the Destination Server
    #check_mysql_version || return 1
...
function ip_change() {
    ...
    echo -e "${BIGreen}Changed${Color_Off} ${BIYellow}IP${Color_Off} ${BICyan}In Database${Color_Off} ${BIYellow}[$smsiTel_db_name]${Color_Off} ${BIRed}[vbSMSServerInfo Table Columns smsServerIP & smsSenderListenIP]${Color_Off} ${BICyan}On The Destination Server${Color_Off}"
    echo
...
function realocate_data() {
    echo -e "${BPurple}                        [${Color_Off} ${BCyan}Backup & Relocate${Color_Off} ${BPurple}]                        ${Color_Off}"
    echo
    local destination_server="$1"
    local folder_name="$2"
    local smsAppFolder="$3"
...
start_services() {
    echo -e "${BPurple}                         [${Color_Off} ${BCyan}Start Services${Color_Off} ${BPurple}]                          ${Color_Off}"
    echo
    ...
    echo -e "${BIRed}-----------------------------------------------------------------------------------------------------${Color_Off}"
    echo -e "${BIRed}|       ${BIGreen}PLease Go To The RIMS & Update The IP [${Color_Off}${BIYellow}New IP :${Color_Off} ${BIRed}$destination_server${Color_Off}${BIGreen}] For This${Color_Off} ${BIRed}[$refNo]${Color_Off}      ${BIRed}|${Color_Off}"
    echo -e "${BIRed}|           ${BIGreen}After Update RIMS You Can Start The Services In The New Server${Color_Off}${BIRed}[$destination_server]${Color_Off}           ${BIRed}|${Color_Off}"
    echo -e "${BIRed}-----------------------------------------------------------------------------------------------------${Color_Off}"
    echo
...
stop_services_Current_server() {
    echo
    echo -e "${BPurple}                          [${Color_Off} ${BCyan}Stop Services${Color_Off} ${BPurple}]                          ${Color_Off}"
    echo
...
client_reply() {
    echo -e "${BPurple}                              [${Color_Off} ${BCyan}Reply${Color_Off} ${BPurple}]                              ${Color_Off}"
    echo
    ...
    echo -e "${BIGreen}Username/Password${Color_Off} ${BIBlue}:${Color_Off} ${BIYellow}Same As Before${Color_Off}"
    echo -e "${BIGreen}SMPP IP${Color_Off} ${BIBlue}:${Color_Off} ${BIRed}$destination_server${Color_Off}"
    echo -e "${BIGreen}SMPP PORT${Color_Off} ${BIBlue}:${Color_Off} $smsSMPPPort${Color_Off}"
    echo -e "${BIGreen}HTTP PORT${Color_Off} ${BIBlue}:${Color_Off} $smsHTTPPort${Color_Off}"
    echo -e "${BIGreen}HTTPS PORT${Color_Off} ${BIBlue}:${Color_Off} $smsHTTPSPort${Color_Off}"
    echo
    echo
    ...
    echo
    echo -e "${BPurple}                            [${Color_Off} ${BCyan}Thank You${Color_Off} ${BPurple}]                            ${Color_Off}"
    echo -e "${BPurple}                    [${Color_Off} ${BCyan}Checking Tomcat & Backup${Color_Off} ${BPurple}]                     ${Color_Off}"
}
