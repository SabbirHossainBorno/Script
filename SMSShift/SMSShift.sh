...
function backup_tomcat() {
    ...
    if ssh -o ControlPath=$SSHSOCKET -p $ssh_port $ssh_user@$destination_server "[ -d '/usr/local/apache-tomcat-7.0.59' ]"; then
        ...
        if [ $? -eq 0 ]; then
            echo -e "${BIGreen}Renamed${Color_Off} ${BICyan}Existing${Color_Off} ${BIYellow}[Apache - Tomcat]${Color_Off} \n${BICyan}Directory :${Color_Off} ${BIRed}$backup_folder${Color_Off}"
            echo
            return 0
        else
...
function create_databases() {
    ...
    #check_mysql_version || return 1
    echo -e "${BPurple}|-----------------------[${Color_Off} ${BCyan}Database Creation${Color_Off} ${BPurple}]-----------------------|${Color_Off}"
    echo
    ...
    if [ $? -eq 0 ]; then
        echo -e "${BIYellow}Databases${Color_Off} ${BIRed}$smsiTel_db_name & $smsfailed_db_name${Color_Off} ${BIGreen}Created Successfully${Color_Off}"
        echo
    else
...
function ip_change() {
    echo -e "${BPurple}|--------------------------[${Color_Off} ${BCyan}IP Replace${Color_Off} ${BPurple}]---------------------------|${Color_Off}"
    echo
    local destination_server="$1"
    local folder_name="$2"
    ...
    echo -e "${BIGreen}Changed${Color_Off} ${BIYellow} IP${Color_Off} ${BICyan}In${Color_Off} ${BIRed}[$smsiTel_db_name]${Color_Off} ${BICyan}On The Destination Server${Color_Off}"
    echo

    # Print the count of IP replacements
    echo -e "${BICyan}---------------------------------------------------------------------${Color_Off}"
    echo -e "${BICyan}|${Color_Off} ${BIGreen}Found${Color_Off} ${BIRed}$serverIP${Color_Off} ${BIBlue}Amount${Color_Off} ${BIYellow}(Configuration.properties)${Color_Off}       ${BIBlue}:${Color_Off} ${BICyan}|${Color_Off} ${BIRed}$config_ip_count${Color_Off} ${BICyan}|${Color_Off}"
    echo -e "${BICyan}---------------------------------------------------------------------${Color_Off}"
    echo -e "${BICyan}|${Color_Off} ${BIGreen}Found${Color_Off} ${BIRed}$serverIP${Color_Off} ${BIBlue}Amount${Color_Off} ${BIYellow}(server.cfg)${Color_Off}                     ${BIBlue}:${Color_Off} ${BICyan}|${Color_Off} ${BIRed}$server_cfg_ip_count${Color_Off} ${BICyan}|${Color_Off}"
    echo -e "${BICyan}---------------------------------------------------------------------${Color_Off}"
    echo -e "${BICyan}|${Color_Off} ${BIGreen}Found${Color_Off} ${BIRed}$serverIP${Color_Off} ${BIBlue}Amount${Color_Off} ${BIYellow}(server.xml)${Color_Off}                     ${BIBlue}:${Color_Off} ${BICyan}|${Color_Off} ${BIRed}$server_xml_ip_count${Color_Off} ${BICyan}|${Color_Off}"
    echo -e "${BICyan}---------------------------------------------------------------------${Color_Off}"
    echo
}
...
function create_backup_folder() {
    ...
    if [ ! -d "/usr/local/$folder_name" ]; then
        ...
        echo -e "${BICyan}Created Backup Folder :${Color_Off} ${BIRed}[$folder_name]${Color_Off} ${BIGreen}Successfully${Color_Off}"
        echo
    else
...
function collect_WholeSaleSMSServer_iTelSMSAppServer() {
    ...
    echo -e "${BICyan}Moving ${Color_Off}${BIRed}[WholeSaleSMSServer$smsFolder${Color_Off} ${BICyan}&${Color_Off} ${BIRed}iTelSMSAppServer$smsAppFolder]${Color_Off} ${BICyan}\n\nDirectory :${Color_Off} ${BIGreen} [/usr/local/$folder_name]${Color_Off}"
    echo
...
function restore_mongodb_databases() {
    echo -e "${BPurple}|-------------------------[${Color_Off} ${BCyan}Mongo Restore${Color_Off} ${BPurple}]-------------------------|${Color_Off}"
    echo
...
function backup_destination_folders() {
    echo -e "${BPurple}|-----------------[${Color_Off} ${BCyan}Existing Service Folder Backup${Color_Off} ${BPurple}]----------------|${Color_Off}"
    echo
    ...
    for keyword in "${keywords[@]}"; do
        for folder in $folders; do
            if [[ "$folder" == *"$keyword"* ]]; then
                ...
                echo -e "${BICyan}Backuped ${BIRed}[$folder]${Color_Off} ${BICyan}\n\nTo${Color_Off} ${BIRed}[${folder}_BK_$backup_timestamp]${Color_Off} ${BICyan}On The Destination Server${Color_Off}"
                echo
            fi
        done
    done
...
function realocate_data() {
    echo -e "${BPurple}|-------------------[${Color_Off} ${BCyan}Relocate Service Frolders${Color_Off} ${BPurple}]-------------------|${Color_Off}"
    echo
    local destination_server="$1"
    local folder_name="$2"
    local smsAppFolder="$3"
...
run_softlink() {
    echo -e "${BPurple}|-------------------------[${Color_Off} ${BCyan}Run Softlink${Color_Off} ${BPurple}]--------------------------|${Color_Off}"
    echo
...
function restart_apacheTomcat {
    echo -e "${BICyan}[ Restarting${Color_Off} ${BIYellow}[Apache - Tomcat] ]${Color_Off}"
    echo
...
start_services() {
    echo -e "${BPurple}|-------------------[${Color_Off} ${BCyan}Start Services[New Server]${Color_Off} ${BPurple}]------------------|${Color_Off}"
    echo
    ...
    echo -e "${BIRed}---------------------------------------------------------------------${Color_Off}"
    echo -e "${BIRed}|                              ${BIRed}WARNING${Color_Off}                              ${BIRed}|${Color_Off}"
    echo -e "${BIRed}---------------------------------------------------------------------${Color_Off}"
    echo -e "${BIRed}|                       ${BIGreen}PLease Go To The RIMS${Color_Off}                       ${BIRed}|${Color_Off}"
    echo -e "${BIRed}|    ${BIGreen}Update The SMPP IP [${Color_Off}${BIYellow}New IP :${Color_Off} ${BIRed}149.20.189.63${Color_Off}${BIGreen}] ${BIRed}[$refNo]${Color_Off}     ${BIRed}|${Color_Off}"
    echo -e "${BIRed}|  ${BIGreen}After Update RIMS You Can Start The Services In ${BIRed}[$destination_server]${Color_Off}  ${BIRed}|${Color_Off}"
    echo -e "${BIRed}---------------------------------------------------------------------${Color_Off}"
    echo
    ...
    echo
    echo -e "${BPurple}|---------------------[${Color_Off} ${BCyan}Checking All Process${Color_Off} ${BPurple}]----------------------|${Color_Off}"
    echo
...
stop_services_Current_server() {
    echo
    echo -e "${BPurple}|-------------------[${Color_Off} ${BCyan}Stop Services[Old Server]${Color_Off} ${BPurple}]-------------------|${Color_Off}"
    echo
...
client_reply() {
    echo -e "${BPurple}|-------------------------[${Color_Off} ${BCyan}Client Reply${Color_Off} ${BPurple}]--------------------------|${Color_Off}"
    echo
    ...
    if [ $? -eq 0 ]; then
        ...
        smsSMPPPort=$(echo "$result" | awk '/smsSMPPPort/ {print $2}')
        smsHTTPPort=$(echo "$result" | awk '/smsHTTPPort/ {print $2}')
        smsHTTPSPort=$(echo "$result" | awk '/smsHTTPSPort/ {print $2}')
    else
    ...
    echo
    echo -e "${BIBlue}As Per Our Sales Manager's Confirmation, We Have Shifted Your REVE SMS Switch.${Color_Off}"
    echo
    echo
    echo -e "${BIYellow}Here Is The All-New INFO${Color_Off}"
    echo
    echo -e "${BIBlue}We Have Shifted Your REVE SMS Switch To A [${BIGreen}New Server${Color_Off}:${BIRed}$destination_server${Color_Off}]${Color_Off}"
    echo
    echo -e "${BIGreen}Billing URL${Color_Off}:${BIRed} http://$destination_server/$billingName/${Color_Off}"
    echo -e "${BIGreen}Username/Password${Color_Off}:${BIYellow} Same As Before${Color_Off}"
    echo -e "${BIGreen}SMPP IP${Color_Off}:${BIRed} $destination_server${Color_Off}"
    echo -e "${BIGreen}SMPP PORT${Color_Off}:${BIRed} $smsSMPPPort${Color_Off}"
    echo -e "${BIGreen}HTTP PORT${Color_Off}:${BIRed} $smsHTTPPort${Color_Off}"
    echo -e "${BIGreen}HTTPS PORT${Color_Off}:${BIRed} $smsHTTPSPort${Color_Off}"
    echo
    echo
    ...
    echo
    echo -e "${BPurple}|----------------------------[${Color_Off} ${BCyan}Cheers${Color_Off} ${BPurple}]-----------------------------|${Color_Off}"
    echo
...
timeout_duration=60  # Timeout in seconds
        ...
        1)
                ...
                echo
                cd /usr/local/
                echo -e "${BICyan}Moving [${Color_Off}${BIRed}Apache - Tomcat${Color_Off}${BICyan}] \n\nDirectory :${Color_Off} ${BIGreen}/usr/local/$folder_name${Color_Off}"
                echo
                cp -r "apache-tomcat-7.0.59" "/usr/local/$folder_name"
                echo -e "${BIRed}Apache - Tomcat${Color_Off} ${BIGreen}Moved Successfully.${Color_Off}"
                echo
                echo -e "${BPurple}|-----------------------------[${Color_Off} ${BCyan}FINISH${Color_Off} ${BPurple}]----------------------------|${Color_Off}"
                echo
                #|-------------------------------------------------------------------------------------------------------------------------------------------|
