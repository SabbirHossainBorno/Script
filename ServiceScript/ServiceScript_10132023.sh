...
echo "export HISTTIMEFORMAT=\"%d/%m/%y %T - User: [$(whoami)], IP: [$(who -m | awk '{print $5}' | sed 's/[()]//g')] \"" >> ~/.bash_profile
. ~/.bash_profile
...
#-----------------------------------------------------AllFunction-------------------------------------------------------
        ...
        # Define the function for restarting iTelSwitchPlusSignaling
restart_iTelSwitchPlusSignaling() {
    ...
    if [[ $? -ne 0 ]]; then
        ...
        restart_iTelSwitchPlusSignaling_BK() {
            echo
            echo -e "${BPurple}iTelSwitchPlusSignaling Shutting Down--->${Color_Off}"
        ...
        restart_jakartaTomcat() {
            ...
            ps aux | grep -v grep | grep 'jakarta' --color=auto
            ...
            while ! grep -q 'Server startup in' catalina.out; do
                sleep 1
            done
        ...
        #Define the function for restaring Jakarta-Tomcat9
        restart_jakartaTomcat9() {
            cd /etc/rc.d/init.d/
            jakartaTomcat9_service_name=$(grep -iRl jakarta-tomcat-9.0.17)
            
            systemctl daemon-reload

            if [[ -z "$jakartaTomcat9_service_name" ]]; then
            
                echo -e "${BRed}Jakarta - Tomcat[9] Not Found!!${Color_Off}"
                echo
            else
                echo -e "${BYellow}Stopping Jakarta - Tomcat[9]${Color_Off}"
                echo
                service $jakartaTomcat9_service_name stop
                service $jakartaTomcat9_service_name stop
                service $jakartaTomcat9_service_name stop
                echo
                ...
                if [[ $kp == 'y' ]]; then
                    ...
                    rm -rf catalina.out
                    echo -e "${BGreen}Starting Apache - Tomcat${Color_Off}"
                    echo
                    
                    sleep 1
                    
                    service $jakartaTomcat9_service_name start
                    echo
                    ps aux | grep -v grep | grep 'jakarta-tomcat-9' --color=auto
                    echo     
                    sleep 2
                    
                    echo -e "${BGreen}Jakarta - Tomcat[9] Restart Complete${Color_Off}"
                    echo
                    ...
                    echo -e "${BGreen}Jakarta - Tomcat[9] Restart Successfully!${Color_Off}"
                    echo
                    ...
                    cd /usr/local/jakarta-tomcat-9.0.17/logs
                    rm -rf catalina.out
                    echo -e "${BGreen}Starting Jakarta - Tomcat[9]${Color_Off}"
                    echo
        ...
        restart_apacheTomcat() {
            ...
            if [[ -z "$apache_service_name" ]]; then
                ...
                ps aux | grep -v grep | grep 'apache-tomcat' --color=auto
                echo
                ...
                echo
                    ...
                    echo -e "${BCyan}Deleting Catalina Directory${Color_Off}"
                    echo
                    cd /usr/local/apache-tomcat-7.0.59/work
                    rm -rf Catalina
                    echo -e "${BCyan}Deleting ( catalina.out ) File${Color_Off}"
                    echo
                    cd /usr/local/apache-tomcat-7.0.59/logs
                    rm -rf catalina.out
                    echo -e "${BGreen}Starting Apache - Tomcat${Color_Off}"
                    echo
                    ...
                    echo -e "${BGreen}Apache - Tomcat Restart Complete${Color_Off}"
                    echo
        ...
        stop_jakartaTomcat() {
            ...
            ps aux | grep -v grep | grep 'jakarta' --color=auto
            echo
            echo -e "${BCyan}Jakarta - Tomcat ${Color_Off}${BYellow}Shutting Down ${BGreen}Successfully.${Color_Off}"
            sleep 2
            echo
...
devloper_INFO() {
echo
echo -e "${BIRed}SERVICE SCRIPT(3.0.1)${Color_Off}"
echo -e "${BIYellow}*-----------------------------------------------------------------------*${Color_Off}"
echo -e "${BRed}TODAY                : ${Color_Off}${BYellow}`date +"%d-%m-%Y"` ${Color_Off}"
echo -e "${BRed}LAST UPDATE          : ${Color_Off}${BYellow}04-09-2023 ${Color_Off}"
echo -e "${BRed}PREVIOUS IMPLEMENTED : ${Color_Off}${BYellow}Modify GZIP Feature + Added Option For Drop Failed Tables ${Color_Off}"
echo -e "${BRed}LAST IMPLEMENTED     : ${Color_Off}${BYellow}ByteSaver Registration Check${Color_Off}"
echo -e "${BIYellow}*-----------------------------------------------------------------------*${Color_Off}"
    ...
    H)
        ...
        5)
            ...
            *)
            ...
            echo -e "${BBlue}*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*${Color_Off}"
            echo
            ps aux | grep -v grep | grep 'ByteSaver|iTelSwitch|jakarta-tomcat' --color=auto
            echo
            sleep 5
            echo
            echo -e "${BBlue}*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*${Color_Off}"
        ...
        HR)
            ...
            *)
            ...
            ps aux | grep -v grep | grep 'jakarta-tomcat' --color=auto
            echo
            sleep 5
            echo
            echo -e "${BBlue}*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*${Color_Off}"
