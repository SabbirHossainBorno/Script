...
echo -e "${BRed}LAST UPDATE          : ${Color_Off}${BYellow}14-05-2023 ${Color_Off}"
echo -e "${BRed}PREVIOUS IMPLEMENTED : ${Color_Off}${BYellow}Max Call Limite Change${Color_Off}"
echo -e "${BRed}LAST IMPLEMENTED     : ${Color_Off}${BYellow}Pin Expire Time + Installer${Color_Off}"
echo -e "${BIYellow}*-----------------------------------------------------------------------*${Color_Off}"
...
case $option in
    ...
    *)
    ...
    echo -e "${BPurple}|${Color_Off}                                           ${BPurple}|${Color_Off}"
    echo -e "  ${BCyan}3T. Service Shift${Color_Off}${BRed} - (TEST MODE)${Color_Off}"
    echo -e "${BPurple}|${Color_Off}                                           ${BPurple}|${Color_Off}"
    echo -e "  ${BCyan}4. Dependencey Install${Color_Off}"
    echo -e "${BPurple}|${Color_Off}                                           ${BPurple}|${Color_Off}"
    echo -e "${BPurple} ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~${Color_Off}"
    echo -e "${BPurple}|${Color_Off}${BGreen}             Pree [e] For Exit             ${Color_Off}${BPurple}|${Color_Off}"
    echo -e "${BPurple} ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~${Color_Off}"
    echo
    echo -e "${BCyan}What Installer You Want To Run?${Color_Off}"
    read choice
    echo
